 ...
 * @psalm-immutable
 */
final class CardwallConvertor extends RendererConvertor
{
    public function buildFromXml(
        ...
        $expr = new New_(
            new Name('\\' . XMLCardwallRenderer::class),
                ...
                [
                    new Arg(
                        new New_(
                            ...
                            [new Arg(new String_($id_to_name_mapping->get((string) $renderer['field_id'])))]
                        )
                    ),
                ]
            );
