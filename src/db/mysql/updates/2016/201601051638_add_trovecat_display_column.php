<?php
/**
 * Copyright (c) BrownBear SAS 2016 - Present. All rights reserved
 *
...
class b201601051638_add_trovecat_display_column extends \Tuleap\ForgeUpgrade\Bucket
{
    ...
    public function convertExistingCategories()
    {
        ...
        $res = $this->db->dbh->exec($sql);
        if ($res === false) {
            throw new \Tuleap\ForgeUpgrade\Bucket\BucketUpgradeNotCompleteException('An error occurred while updating the trove_cat table values.');
        }
    }
}
