...
class SynchronizedProjectMembershipDuplicator
{
    ...
    public function duplicate(int $template_id, Project $destination): void
    {
        if (! $destination->isPublic()) {
            return;
        }
        $this->dao->duplicateActivationFromTemplate(
            $template_id,
