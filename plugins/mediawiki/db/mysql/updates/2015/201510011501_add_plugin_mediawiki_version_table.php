<?php
/**
 * Copyright (c) BrownBear SAS - 2015 - Present. All rights reserved
 *
...
class b201510011501_add_plugin_mediawiki_version_table extends \Tuleap\ForgeUpgrade\Bucket
{
    /**
    ...
    {
        return <<<EOT
Add plugin_mediawiki_version table
EOT;
    }
