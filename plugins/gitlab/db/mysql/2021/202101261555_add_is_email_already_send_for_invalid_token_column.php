...
final class b202101261555_add_is_email_already_send_for_invalid_token_column extends \Tuleap\ForgeUpgrade\Bucket
{
    ...
    {
        return 'Add is_email_already_send_for_invalid_token in plugin_gitlab_bot_api_token table';
    }
    ...
    public function up(): void
    {
        $this->db->alterTable(
            ...
            'ALTER TABLE plugin_gitlab_bot_api_token
                ADD COLUMN is_email_already_send_for_invalid_token BOOL NOT NULL DEFAULT FALSE'
        );
    }
}
