...
{foreach from=$commits_per_day->commits item=commit_presenter}
    <div
        {if isset($mark) && $mark and $mark->GetHash() == $commit_presenter->commit->GetHash()}
        ...
        {/if}
        data-href="?a=commit&amp;h={$commit_presenter->commit->GetHash()|urlencode}"
    >
        ...
        <div class="tlp-avatar git-repository-commit-card-avatar">
            {if isset($searchtype) && $searchtype == 'committer'}
        ...
        <div class="git-repository-commit-card-info">
            <p class="git-repository-commit-card-info-title">
                {if isset($searchtype) && $searchtype == 'commit'}
            ...
            <div class="git-repository-commit-card-info-metadata">
                <span class="git-repository-commit-card-info-metadata-username">
                    {if isset($searchtype) && $searchtype == 'author'}
                        ...
                        {/if}
                    {elseif isset($searchtype) && $searchtype == 'committer'}
        ...
        <div class="tlp-button-bar">
            {if isset($mark) && $mark}
                {if $mark->GetHash() !== $commit_presenter->commit->GetHash()}
                    ...
                    <div class="tlp-button-bar-item">
                        <a class="tlp-button-primary tlp-button-outline tlp-button-small"
                           href="?a=commitdiff&amp;h={$markbase->GetHash()|urlencode}&amp;hp={$markparent->GetHash()|urlencode}">
                ...
                {else}
                    <div class="tlp-button-bar-item">
                        <a class="tlp-button-primary tlp-button-outline tlp-button-small"
                           href="?a=shortlog&amp;h={$shortlog_presenter->first_commit->commit->getHash()|urlencode}&amp;pg={$page}">
            ...
            <div class="tlp-button-bar-item">
                <a class="tlp-button-primary tlp-button-outline tlp-button-small"
                    href="?a=commitdiff&amp;h={$commit_presenter->commit->GetHash()|urlencode}"
                >
            ...
            <div class="tlp-button-bar-item tlp-dropdown">
                ...
                <div class="tlp-dropdown-menu tlp-dropdown-menu-right" role="menu">
                    ...
                    {/if}
                    <a class="tlp-dropdown-menu-item"
                       href="?a=tree&amp;h={$revtree->GetHash()|urlencode}&amp;hb={$commit_presenter->commit->GetHash()|urlencode}"
                    >
