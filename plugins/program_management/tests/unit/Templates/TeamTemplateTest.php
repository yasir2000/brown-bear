...
final class TeamTemplateTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->program_template         = new TeamTemplate(
    ...
    public function testItShouldBuildTheXMLPathAndCopyTheXMLFilesInsideIt(): void
    {
        ...
        $program_template_dir = $this->template_cache_directory . '/team';

        self::assertEquals($program_template_dir . '/project.xml', $xml_path);
        self::assertTrue($this->root_dir->hasChild('program_management_template/team/project.xml'));
        self::assertTrue($this->root_dir->hasChild('program_management_template/team/testmanagement.xml'));
    }
}
