...
final class VerifyIsIterationTrackerStub implements VerifyIsIterationTracker
{
    ...
    public static function buildValidIteration(): self
    {
        return new self(true);
    }

    public static function buildNotIteration(): self
    {
